...
const NavBar = () => {
  return (
    <div className=' fixed  bg-shark-950  w-full top-0 text-white flex items-center justify-between px-4 lg:px-8 py-2'>
        <h1 className='text-bold  hover:text-mantis-400 text-2xl '>Mi Portafolio</h1>
